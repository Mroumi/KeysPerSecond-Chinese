...
public class Menu{
	 ...
	 * The general menu.
	 */
	private static final JMenu general = new JMenu("通用");
	/**
	 * Update rate menu.
	 */
	private static final JMenu rate = new JMenu("刷新率");
	/**
	 * Reset menu.
	 */
	...
	protected static final void createMenu(){
		...
		JMenuItem snap = new JMenuItem("对齐到边缘");
		JMenuItem exit = new JMenuItem("退出");
		JMenuItem sreset = new JMenuItem("重置统计数据（AVG,MAX）");
		JMenuItem sresetmax = new JMenuItem("重置最大CUR（MAX）");
		JMenuItem sresetavg = new JMenuItem("重置平均CUR（AVG）");
		JMenuItem sresettot = new JMenuItem("重置总数（TOT）");
		JMenuItem sresetgraph = new JMenuItem("重置图像");
		JMenuItem treset = new JMenuItem("重置按键总数");
		JMenuItem configkeys = new JMenuItem("按键");
		JMenuItem colorcustom = new JMenuItem("调整颜色");
		JMenuItem statsSaving = new JMenuItem("自动保存");
		JMenuItem commandkeys = new JMenuItem("快捷键");
		JMenuItem layout = new JMenuItem("布局");
		JMenuItem about = new JMenuItem("关于");
		JMenuItem minimizeButton = new JMenuItem("隐藏到托盘");
		JCheckBoxMenuItem tAllKeys = new JCheckBoxMenuItem("记录所有键盘按键");
		JCheckBoxMenuItem tAllButtons = new JCheckBoxMenuItem("记录所有鼠标按键");
		JCheckBoxMenuItem overlay = new JCheckBoxMenuItem("置于顶层");
		JCheckBoxMenuItem modifiers = new JCheckBoxMenuItem("记录键盘修饰符按键");
		...
		JMenuItem saveStats = new JMenuItem("保存按键数量");
		JMenuItem loadStats = new JMenuItem("加载按键数量");
