...
public class AboutDialog extends JPanel{
	...
	public AboutDialog(){
		...
		add(new JLabel(
			"<html>KeysPerSecond 是一个开源的输入统计信息显示工具"
			+ "<br>使用GPLv3 许可证下免费发布. 任何关于该工具的漏洞"
			+ "<br>或功能请求都可以在 GitHub 上报告。</html>"
		), gc);
		...
		line.add(new JLabel("  - "));
		JLabel label = new JLabel("<html><font color=blue><u>主页</u></font></html>");
